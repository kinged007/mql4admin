...
CREATE TABLE `mql4message` (
  ...
  `equity` varchar(55) DEFAULT NULL,
  `margin` varchar(55) DEFAULT NULL,
  `margin_level` varchar(55) DEFAULT NULL,
  `free_margin` varchar(55) DEFAULT NULL,
  `leverage` varchar(55) DEFAULT NULL,
  `name` varchar(55) DEFAULT NULL,
  `profit` varchar(55) DEFAULT NULL,
  `stopout_call` varchar(55) DEFAULT NULL,
  `stopout_stopout` varchar(55) DEFAULT NULL,
  `trade_permitted` varchar(55) DEFAULT NULL,
  `ea_permitted` varchar(55) DEFAULT NULL,
  `dll_allowed` varchar(55) DEFAULT NULL,
  ...
  `start_balance_day` varchar(55) DEFAULT NULL,
  `start_balance_week` varchar(55) DEFAULT NULL,
  `start_balance_month` varchar(55) DEFAULT NULL,
